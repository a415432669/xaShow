	...
	NHnr: function NHnr(t, i, e) {
		...
		var c = e("Z0/y")({
			...
			bulidCal: function bulidCal(t, i) {
				...
				var s,
				    a,
				    n = new Date(t, i - 1, 1).getDay(),
				    o = d.getDaysInmonth(i, t),
				    c = 1;
				for (e[0][0] = "日", e[0][1] = "一", e[0][2] = "二", e[0][3] = "三", e[0][4] = "四", e[0][5] = "五", e[0][6] = "六", s = n; s < 7; s++) {
					e[1][s] = c, c++;
				}for (a = 2; a < 7; a++) {
					for (s = 0; s < 7; s++) {
						c <= o && (e[a][s] = c, c++);
			...
			!function (t, i) {
				...
				"ongesturestart" in i && (a = "gesturestart", n = "gesturechange", o = "gestureend"), t.Zoom = function (i, c) {
					...
					l.onPinchstart = function (t) {
						...
						if ("number" == typeof i && (e = i, i = void 0), e = void 0 === e ? l.options.speed : e, r && 1 !== r) r = A = 1, l.scrollerTransition(e).scrollerTransform(0, 0);else if (r = A = l.options.maxZoom, i) {
		...
		var V = function V() {
			!function (t, i) {
				...
				a.init = function () {
					...
					this.groups = {};
					var e = [];
					if ((e = t ? "__DEFAULT" === t ? document.querySelectorAll("img[data-preview-src]:not([data-preview-group])") : document.querySelectorAll("img[data-preview-src][data-preview-group='" + t + "']") : document.querySelectorAll("img[data-preview-src]")).length) for (var s = 0, a = e.length; s < a; s++) {
						this.addImage(e[s]);
					}
					...
					if (this.isShown()) {
						...
						for (var r = this.element.querySelectorAll(t.classSelector(".zoom-wrapper")), A = 0, h = r.length; A < h; A++) {
							t(r[A]).zoom().destroy();
			...
			methods: {
				...
				playAudio: function playAudio(t) {
					...
					if (e.paused) {
						for (var a = 0; a < s; a++) {
							this.$refs.audio[a].pause(), this.$set(this.playStates, a, !1), clearInterval(this.timerInter);
